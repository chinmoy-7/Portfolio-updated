    ...
    <div className=' lg:w-2/6  xl:w-2/6 h-4/6 sm:h-full sm:items-start justify-center flex flex-col sm:flex-row items-center   w-full'>
        <div className='h-5/6  w-3/4 mt-3 flex flex-col justify-evenly rounded-xl bg-lightOnyx'>
            ...
            <div className='h-2/3 flex flex-col items-center justify-around '>
                ...
                <div className='flex'>
                    <a href='https://www.linkedin.com/in/chinmoy-dehingia-02a352137/' target='__blank'><img src="./link.png" alt="" className='cursor-pointer hover:bg-white ease-in duration-100 rounded-md'/></a>
                    <a href="https://www.instagram.com/c_dehingia/" target='__blank'><img src="./insta.png" alt="" className='cursor-pointer hover:bg-white ease-in duration-100 rounded-md'/></a>
                    <a href="https://github.com/chinmoy-7" target='__blank'><img src="./git.png" alt="" className='cursor-pointer hover:bg-white ease-in duration-100 rounded-md'/></a>
                </div>
                {/* <div className='w-3/6 h-18 py-10'> */}
                    <button onClick={props.scrollToContact} className='bg-noiceGreen w-3/6 h-10  m-6 hover:bg-white hover:ease-in duration-200 rounded-full'>Hire me!</button>
                {/* </div> */}
            </div>
        </div>
    </div>
        ...
        <div className='text-white  lg:w-2/6 xl:w-4/6 h-1/3 sm:h-full justify-around flex flex-col sm:flex-col items-center
         sm w-full  lg:justify-start lg:items-start lg:py-32 '>
            <h2 className='text-2xl lg:text-6xl'>Say Hi To <span className='text-noiceGreen tracking-wide'>Chinmoy,</span><br/>Full Stack Developer</h2>
        ...
        <div className='text-white hidden lg:w-1/6 xl:w-1/6 h-4/6 sm:h-full justify-center lg:flex flex-col sm:flex-row items-center sm w-full fixed right-0'>
            <div className=' h-1/3 w-1/6 rounded-md border-2 border-gray-500 fill-white flex flex-col justify-around items-center '>
                ...
                <img onClick={props.scrollToContact} src="skills.png "  className="w-5/6 cursor-pointer hover:rounded-md hover:bg-gray-50" alt="" />
            </div>
        </div>
</div>
  )
